    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <p>Kami menyambut baik terbitnya website SMAS AL KAUTSAR yang baru, dengan harapan dipublikasinya website ini sekolah berharap : Peningkatan layanan pendidikan kepada siswa, orangtua, dan masyrakat umum semakin meningkat.</p>
        </div>
        ...
        <div class="row portfolio-container">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                <h4>Pelantikan Kepala Sekolah</h4>
              </div>
              <div class="portfolio-links">
                <a href="assets/aset/img/portfolio/portfolio-2.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Pelantikan Kepala Sekolah"><i class="bx bx-info-circle"></i></a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                <h4>Pelaksanaan KBM</h4>
              </div>
              <div class="portfolio-links">
                <a href="assets/aset/img/portfolio/portfolio-3.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Pelaksanaan KBM"><i class="bx bx-info-circle"></i></a>
              </div>
            </div>
          </div> 
        </div>
